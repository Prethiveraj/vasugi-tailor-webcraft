    ...
    <section className="py-16 bg-tailor-light">
      <div className="container mx-auto px-4">
            ...
            <Card key={index} className="border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardFooter className="justify-center pt-2">
                <Link to={service.link}>
                  <Button className="bg-tailor-maroon hover:bg-tailor-dark text-white">Learn More</Button>
                </Link>
              </CardFooter>
            </Card>
          ))}
        ...
        <div className="text-center mt-12">
          <Link to="/services">
            <Button variant="outline" className="border-tailor-maroon text-tailor-maroon hover:bg-tailor-maroon hover:text-white">
              View All Services
            </Button>
          </Link>
        </div>
